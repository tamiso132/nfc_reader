...
class Command{
 ...
 int sw2 = response[response.length - 1];
  ...
  static Future<ResponseCommand> mseSetAT(IsoDepAndroid isoDep, Uint8List oid, Uint8List password, int parameterID, {Uint8List? chat, int cla = 0x00}) async{

   Uint8List data = AsnBuilder().addCustomTag(0x80, oid)
       .addCustomTag(0x83, password)
       .addCustomTag(0x84, Uint8List.fromList([parameterID]))
       .build();
